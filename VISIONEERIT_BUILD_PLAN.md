...
| Google Sheets credential (dashboard, dedupe, suppression log) | `[DONE 2026-08-16]` — service-account auth, not OAuth (installs headlessly). n8n credential `VIO Google Sheets` (`VIOgsheetcred01`); all four tabs live. Setup: `n8n-workflows/setup-google-sheets.py` |
